...
<div style="margin:10px;">
	...
	<table style=" border:4px solid #9AC5F4; background:#ECF9FF; height:50px;">
		<tr >
			<th style=" border:4px solid #9AC5F4; background:#ECF9FF; height:50px; width:120px; text-align:center; font-size:20px;"><p style="color:#0081C9; margin:0 auto;">유인팬 속도</p></th>
